...
public static class Il2CppGame
{
	...
	public static void Process(string gameExePath, string outputFolder, Cpp2IlOutputFormat outputFormat, List<Cpp2IlProcessingLayer> processingLayers)
	{
		Process(gameExePath, processingLayers);

		outputFormat.DoOutput(GetCurrentAppContext(), outputFolder);
	}

	public static void Process(string gameExePath, List<Cpp2IlProcessingLayer> processingLayers)
	{

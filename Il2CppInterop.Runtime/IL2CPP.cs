    ...
    public static unsafe class IL2CPP
    {
        ...
        public static IntPtr GetIl2CppField(IntPtr clazz, string fieldName)
        {
            ...
            if (field == IntPtr.Zero)
                Logger.Error($"Field {fieldName} was not found on class {Marshal.PtrToStringAnsi(il2cpp_class_get_name(clazz))}");
            return field;
        }
        ...
        public static IntPtr GetIl2CppMethod(IntPtr clazz, bool isGeneric, string methodName, string returnTypeName, params string[] argTypes)
        {
            ...
            if (methodsSeen == 1)
            {
                Logger.Trace($"Method {className}::{methodName} was stubbed with a random matching method of the same name");
                Logger.Trace($"Stubby return type/target: {Marshal.PtrToStringAnsi(il2cpp_type_get_name(il2cpp_method_get_return_type(lastMethod)))} / {returnTypeName}");

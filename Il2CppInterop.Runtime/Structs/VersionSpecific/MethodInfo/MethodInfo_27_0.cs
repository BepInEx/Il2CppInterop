...
namespace Il2CppInterop.Runtime.Structs.VersionSpecific.MethodInfo
{
    ...
    public unsafe class NativeMethodInfoStructHandler_27_0 : INativeMethodInfoStructHandler
    {
        private NativeMethodInfoStructHandler_27_0()
        {
        }
        public INativeMethodInfoStruct CreateNewStruct()
        {
            nint ptr = Marshal.AllocHGlobal(Size);
            Il2CppMethodInfo_27_0* _ = (Il2CppMethodInfo_27_0*)ptr;
            *_ = default;
        ...
        public static NativeMethodInfoStructHandler_27_0 Instance { get; } = new();
        public int Size => sizeof(Il2CppMethodInfo_27_0);
        internal unsafe struct Il2CppMethodInfo_27_0
        {
        ...
        internal class NativeStructWrapper : INativeMethodInfoStruct
        {
            ...
            private static int _bitfield0offset = Marshal.OffsetOf<Il2CppMethodInfo_27_0>(nameof(Il2CppMethodInfo_27_0._bitfield0)).ToInt32();
            public nint Pointer { get; }
            private Il2CppMethodInfo_27_0* _ => (Il2CppMethodInfo_27_0*)Pointer;
            ...
            public ref nint VirtualMethodPointer => ref *(nint*)&_->virtualMethodPointer;
            ...
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_generic);
                set => this.SetBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_generic, value);
            }
            public bool IsInflated
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_inflated);
                set => this.SetBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_inflated, value);
            }
            public bool IsMarshalledFromNative
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_marshaled_from_native);
                set => this.SetBit(_bitfield0offset, (int)Il2CppMethodInfo_27_0.Bitfield0.BIT_is_marshaled_from_native, value);
            }
        }
    }
}

...
namespace Il2CppInterop.Runtime.Structs.VersionSpecific.MethodInfo
{
    ...
    {
        private NativeMethodInfoStructHandler_16_0()
        {
        }
        ...
        public static NativeMethodInfoStructHandler_16_0 Instance { get; } = new();
        ...
        internal class NativeStructWrapper : INativeMethodInfoStruct
        {
            ...
            public ref nint MethodPointer => ref *(nint*)&_->method;
            public ref nint VirtualMethodPointer => ref *(nint*)&_->method;

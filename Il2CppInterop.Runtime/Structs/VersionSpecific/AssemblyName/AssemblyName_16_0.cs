...
namespace Il2CppInterop.Runtime.Structs.VersionSpecific.AssemblyName
{
    ...
    {
        private NativeAssemblyNameStructHandler_16_0()
        {
        }
        ...
        public static NativeAssemblyNameStructHandler_16_0 Instance { get; } = new();
        ...
        internal class NativeStructWrapper : INativeAssemblyNameStruct
        {
            ...
            public ref nint Name => ref *(nint*)&_->nameIndex;
            public ref nint Culture => ref *(nint*)&_->cultureIndex;
            public ref nint PublicKey => ref *(nint*)&_->publicKeyIndex;

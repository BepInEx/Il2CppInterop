...
{
    [ApplicableToUnityVersionsSince("2021.2.0a21")]
    [ApplicableToUnityVersionsSince("2022.1.0")]
    public unsafe class NativeClassStructHandler_27_5 : INativeClassStructHandler
    {
        private NativeClassStructHandler_27_5()
        {
        }
        public INativeClassStruct CreateNewStruct(int vTableSlots)
        {
            ...
            Il2CppClass_27_5* _ = (Il2CppClass_27_5*)ptr;
            *_ = default;
        ...
        public static NativeClassStructHandler_27_5 Instance { get; } = new();
        public int Size => sizeof(Il2CppClass_27_5);
        internal unsafe struct Il2CppClass_27_5
        {
        ...
        internal class NativeStructWrapper : INativeClassStruct
        {
            ...
            private static int _bitfield0offset = Marshal.OffsetOf<Il2CppClass_27_5>(nameof(Il2CppClass_27_5._bitfield0)).ToInt32();
            private static int _bitfield1offset = Marshal.OffsetOf<Il2CppClass_27_5>(nameof(Il2CppClass_27_5._bitfield1)).ToInt32();
            public nint Pointer { get; }
            private Il2CppClass_27_5* _ => (Il2CppClass_27_5*)Pointer;
            public unsafe VirtualInvokeData* VTable => (VirtualInvokeData*)nint.Add(Pointer, sizeof(Il2CppClass_27_5));
            ...
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_initialized);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_initialized, value);
            }
            public bool EnumType
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_enumtype);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_enumtype, value);
            }
            public bool IsGeneric
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_is_generic);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_is_generic, value);
            }
            public bool HasReferences
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_has_references);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_has_references, value);
            }
            public bool SizeInited
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_size_inited);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_size_inited, value);
            }
            public bool HasFinalize
            {
                get => this.CheckBit(_bitfield1offset, (int)Il2CppClass_27_5.Bitfield1.BIT_has_finalize);
                set => this.SetBit(_bitfield1offset, (int)Il2CppClass_27_5.Bitfield1.BIT_has_finalize, value);
            }
            public bool IsVtableInitialized
            {
                get => this.CheckBit(_bitfield1offset, (int)Il2CppClass_27_5.Bitfield1.BIT_is_vtable_initialized);
                set => this.SetBit(_bitfield1offset, (int)Il2CppClass_27_5.Bitfield1.BIT_is_vtable_initialized, value);
            }
            public bool InitializedAndNoError
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_initialized_and_no_error);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_27_5.Bitfield0.BIT_initialized_and_no_error, value);
            }
        }
    }
}

...
{
    [ApplicableToUnityVersionsSince("5.6.0b3")]
    public unsafe class NativeClassStructHandler_23_1 : INativeClassStructHandler
    {
        private NativeClassStructHandler_23_1()
        {
        }
        public INativeClassStruct CreateNewStruct(int vTableSlots)
        {
            ...
            Il2CppClass_23_1* _ = (Il2CppClass_23_1*)ptr;
            *_ = default;
        ...
        public static NativeClassStructHandler_23_1 Instance { get; } = new();
        public int Size => sizeof(Il2CppClass_23_1);
        internal unsafe struct Il2CppClass_23_1
        {
        ...
        internal class NativeStructWrapper : INativeClassStruct
        {
            ...
            private static int _bitfield0offset = Marshal.OffsetOf<Il2CppClass_23_1>(nameof(Il2CppClass_23_1._bitfield0)).ToInt32();
            private static int _bitfield1offset = Marshal.OffsetOf<Il2CppClass_23_1>(nameof(Il2CppClass_23_1._bitfield1)).ToInt32();
            private Il2CppClass* _klassDummy;
            public nint Pointer { get; }
            private Il2CppClass_23_1* _ => (Il2CppClass_23_1*)Pointer;
            ...
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_valuetype);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_valuetype, value);
            }
            public bool Initialized
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_initialized);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_initialized, value);
            }
            public bool EnumType
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_enumtype);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_enumtype, value);
            }
            public bool IsGeneric
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_is_generic);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_is_generic, value);
            }
            public bool HasReferences
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_has_references);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_has_references, value);
            }
            public bool SizeInited
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_size_inited);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_size_inited, value);
            }
            public bool HasFinalize
            {
                get => this.CheckBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_has_finalize);
                set => this.SetBit(_bitfield0offset, (int)Il2CppClass_23_1.Bitfield0.BIT_has_finalize, value);
            }
            public bool IsVtableInitialized
            {
                get => this.CheckBit(_bitfield1offset, (int)Il2CppClass_23_1.Bitfield1.BIT_is_vtable_initialized);
                set => this.SetBit(_bitfield1offset, (int)Il2CppClass_23_1.Bitfield1.BIT_is_vtable_initialized, value);
            }
